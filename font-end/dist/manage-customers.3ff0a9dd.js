...
})({"UYyuG":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cf3c9c133ff0a9dd";
"use strict";
...
},{}],"in9KE":[function(require,module,exports) {
...
function isValid() {
    ...
    let validity = true;
    resetForm();
    if (!address) validity = invalidate(txtAddressElm, "Address can not be empty");
    else if (!/^.{3,}$/.test(address)) validity = invalidate(txtAddressElm, "Invalid address");
    if (!contact) validity = invalidate(txtContactElm, "Contact can not be empty");
    else if (!/^\d{3}-\d{7}$/.test(contact)) validity = invalidate(txtContactElm, "Invalid number");
    if (!name) validity = invalidate(txtNameElm, "Name can not be empty");
    else if (!/^[A-Za-z ]+$/.test(name)) validity = invalidate(txtNameElm, "Invalid name");
    return validity;
}
...
function getId() {
    if (!customerList.length) txtIdElm.val("C001");
    else {
...
},{}]},["UYyuG","in9KE"], "in9KE", "parcelRequire94c2")

//# sourceMappingURL=manage-customers.3ff0a9dd.js.map
